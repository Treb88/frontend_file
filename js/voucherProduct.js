...
const productListVoucher = document.querySelector('.js-product-list-voucher');

const voucherCategory = 'Voucher';

productListVoucher.innerHTML = '';

products.forEach(product => {

    if (product.category === voucherCategory) {
    ...
    const productItem = `
                ...
                productListVoucher.innerHTML += productItem;
