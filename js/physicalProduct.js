import { addToCart, updateCartUI } from "./cartData.js";
import { products } from "./productData.js";


const productListPhysical = document.querySelector('.js-product-list-physical');

const physicalCategory = 'Physical';

productListPhysical.innerHTML = '';

products.forEach(product => {

    if (product.category === physicalCategory) {
    ...
    const productItem = `
                ...
                productListPhysical.innerHTML += productItem;
